...
<table class="table table-striped">
   ...
   for( ProcessedItem r : processedItem)
   {
 %>
    <tbody>
      <tr>
        ...
        <td> <%= r.getPunit() %></td>
        <td> <%= r.getPcost() %></td>
        <td> <a href="deleteItem/<%= r.getPid() %>">Delete</a> </td>
        <td> <a href="updateItem?id=<%= r.getPid() %>">Update</a> </td>
         <td> <a href="issueProcessedItem?id=<%=r.getPid()%>">Issue</a> </td>
